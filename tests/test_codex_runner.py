...
from geng_agent.codex_runner import CODEX_CLI_HELP_PROBE_TIMEOUT_SECONDS, DEFAULT_GENG_CODEX_MODEL, _clear_ephemeral_capability_cache, run_codex_subprocess
...
class CodexRunnerEphemeralTests(unittest.TestCase):
    ...
    def test_default_command_is_ephemeral_and_prompt_stays_on_stdin(self) -> None:
        self.assertEqual(DEFAULT_GENG_CODEX_MODEL, "gpt-6-astra")
