...
class PromptTests(unittest.TestCase):
    ...
    def test_active_analysis_prompts_render(self) -> None:
        ...
        self.assertIn("attempts the next operation", rendered["planning"])
        self.assertIn("Reporter independently checks your task contract", rendered["planning"])
        self.assertNotIn("decides whether to approve or return work to you", rendered["planning"])
        self.assertNotIn("the supervisor assesses whether the evidence is sufficient", rendered["understanding"])
